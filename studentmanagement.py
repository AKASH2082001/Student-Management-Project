...
while True:
    ...
    if choice == 1:
        ...
        result = connection.execute("insert into student(name,rollno,admino,examname,english,maths,physics,chemistry,biology) values('"+getname+"',"+getrollno+","+getadmino+",'"+getexamname+"',"+getenglish+","+getmaths+","+getphysics+","+getchemistry+","+getbiology+")")
        ...
        table = PrettyTable(["Id","name","rollno","admino","examname","english","maths","physics","chemistry","biology"])
        for i in result:
        ...
        result = connection.execute("update student set name='"+getname+"',rollno="+getrollno+",examname='"+getexamname+"',english="+getenglish+",maths="+getmaths+",physics="+getphysics+",chemistry="+getchemistry+",biology="+getbiology+" where admino="+getadmino+"")
        connection.commit()
